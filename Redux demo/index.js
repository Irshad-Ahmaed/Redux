...
unSubscribe();  // if we don't call unsubscribe it'll always generate console message 

store.dispatch(shakeOrder());  // you won't see the unsubscribe console message here, BUT changes will still occur

console.log(store.getState()); // you can see the change here
